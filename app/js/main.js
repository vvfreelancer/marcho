...
function initMap() {
  map = new google.maps.Map(document.getElementById("map"), {
    center: { lat: 40.80446902702659, lng: -73.96603224765619 },
    zoom: 13,
    styles: [
      { elementType: "geometry", stylers: [{ color: "#f4485e" }] },
      { elementType: "labels.text.stroke", stylers: [{ color: "#f4485e" }] },
      { elementType: "labels.text.fill", stylers: [{ color: "#f4485e" }] },
      {
        featureType: "administrative.locality",
        elementType: "labels.text.fill",
        stylers: [{ color: "#f4485e" }],
      },
      {
        featureType: "poi",
        elementType: "labels.text.fill",
